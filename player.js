...
{	
	...
	if(keyboard.isKeyDown(keyboard.KEY_Z) == true)
	{
		...
		if(this.direction == LEFT && this.sprite.currentAnimation != ANIM_REG_PUNCH_LEFT ) {
			this.sprite.setAnimation(ANIM_REG_PUNCH_LEFT);
		}
		else if(this.direction == RIGHT && this.sprite.currentAnimation != ANIM_REG_PUNCH_RIGHT) {
			this.sprite.setAnimation(ANIM_REG_PUNCH_RIGHT);
		}
